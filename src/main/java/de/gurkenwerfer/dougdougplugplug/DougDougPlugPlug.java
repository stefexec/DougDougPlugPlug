...
import de.gurkenwerfer.dougdougplugplug.listeners.BanInventoryListener;
...
public final class DougDougPlugPlug extends JavaPlugin {
    ...
    public static de.gurkenwerfer.dougdougplugplug.filemanager.buildModePermConfig  buildModePermConfig;
    ...
    public void onEnable() {
        ...
        getCommand("buildmode").setExecutor(new buildModeCommand(this, this.luckPerms));
        getServer().getPluginManager().registerEvents(new buildModeListener(), this);
        getServer().getPluginManager().registerEvents(new BanInventoryListener(this, this.luckPerms), this);
